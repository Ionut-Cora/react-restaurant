        ...
        <div className="container my-5">
            <div className="flex-column-reverse flex-lg-row row">
                <div className="col-lg-6 d-flex justify-content-center">
                    <img src={AboutSectionImg} className='about-section-img img-fluid mt-5 mt-lg-0' alt="about us" />
                </div>
                <div className="col-lg-6 d-flex flex-column justify-content-center">
                    ...
                    <Link to='/about'>
                        <button type='button' className='btn btn-dark btn-lg text-capitalize'>More about us</button>
                    </Link>
                </div>
            </div>
        </div>
